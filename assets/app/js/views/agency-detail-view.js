...
export function agencyDetailView(state){
  ...
  return el('div',{class:'page agency-detail-page'},
    ...
    can('operations.create',state) ? el('button',{class:'btn btn-primary btn-block',type:'button','data-action':'create-operation-from-agency','data-agency-id':agency.id || agency.numero},'＋ Crear operación para esta agencia') : null,
