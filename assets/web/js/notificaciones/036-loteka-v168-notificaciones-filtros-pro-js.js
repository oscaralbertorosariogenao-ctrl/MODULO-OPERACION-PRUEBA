...
(function(){
  ...
  function ensureDOM(){
    if(!qs('#ltkNotifV80821Style')){
      ...
      fixStyle.textContent='body.ltk-notif-modal-open{overflow:hidden!important}.ltk-notif-detail-modal{inset:var(--go-fixed-header-offset,62px) 0 0!important;z-index:1000025!important;align-items:flex-start!important;overflow:auto!important;padding:18px!important}.ltk-notif-detail-card{max-height:calc(100dvh - var(--go-fixed-header-offset,62px) - 36px)!important;margin:0 auto!important}.ltk-notif-detail-body{overscroll-behavior:contain}.ltk-notif-panel{z-index:1000024!important;top:calc(var(--go-fixed-header-offset,62px) + 8px)!important;height:calc(100dvh - var(--go-fixed-header-offset,62px) - 16px)!important}@media(max-width:700px){.ltk-notif-detail-modal{inset:var(--go-fixed-header-offset,58px) 0 0!important;padding:10px!important}.ltk-notif-detail-card{max-height:calc(100dvh - var(--go-fixed-header-offset,58px) - 20px)!important}.ltk-notif-panel{top:calc(var(--go-fixed-header-offset,58px) + 6px)!important;height:calc(100dvh - var(--go-fixed-header-offset,58px) - 12px)!important}}';
